 ...
 * http://langserver.org
 ...
 | Nim                   |                 | [[https://github.com/emacs-lsp/lsp-mode][lsp-mode]]    | [[http://github.com/frgomes/bash-scripts/blob/master/bin/install_nim][install_nim]]            |
...
** Aditional useful tools
 | Package  | Purpose                                                                                      | Status |
 |----------+----------------------------------------------------------------------------------------------+--------|
 | [[https://github.com/licht1stein/obsidian.el][Obsidian]] | [[http://obsidian.md][Obsidian]] is a powerful knowledge base on top of a local folder of plain text Markdown files. | done   |
 | [[http://github.com/alphapapa/ement.el][Ement]]    | [[http://matrix.org][Matrix]] client                                                                                | done   |
...
You can skip reading the remainder of this file, unless you'd like to learn how to configure Emacs.
** Disable menus
...
;;FIXME: https://github.com/Alexander-Miller/treemacs/issues/1047
#+begin_src emacs-lisp
(use-package doom-themes
  :hook (after-init . (load-theme (car custom-enabled-themes)) ))
...
*** CSharp
#+BEGIN_SRC emacs-lisp
  ;;FIXME (use-package csharp-mode :demand)
#+END_SRC    
*** Clojure
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
*** Mojo
Mojo programming language support is still incipient at:
https://github.com/andcarnivorous/mojo-hl/

The configuration below was copied from there from the time being.
#+BEGIN_SRC emacs-lisp
...
Support Mojo programming language via eglot.
#+BEGIN_SRC emacs-lisp
(use-package eglot
  :ensure t
      :defer t
...
#+END_SRC
*** Obsidian
[[http://obsidian.md][Obsidian]] is a powerful knowledge base on top of a local folder of plain text Markdown files.
#+BEGIN_SRC emacs-lisp
(defvar user-obsidian-directory "~/Documents/Notes" "Directory for Obsidian notes")
(if (not (file-directory-p user-obsidian-directory))(make-directory user-obsidian-directory))
(if (not (file-directory-p (concat user-obsidian-directory "/Inbox")))(make-directory (concat user-obsidian-directory "/Inbox")))
(use-package obsidian
  :straight
;;    (:host github :repo "licht1stein/obsidian.el" :branch "merge-hydra" :files ("*.el"))
    (:host github :repo "licht1stein/obsidian.el" :branch "master" :files ("*.el"))
  :demand t
  :config
    (obsidian-specify-path user-obsidian-directory)
...
#+END_SRC
*** Ement
[[https://github.com/alphapapa/ement.el][Ement]] is a [[http://matrix.org][Matrix]] client.
#+BEGIN_SRC emacs-lisp
(use-package ement
  :straight
    (:host github :repo "alphapapa/ement.el" :branch "master") ;; :files ("*.el"))
  :demand t)
#+END_SRC
...
#+END_SRC
;;** Disable file watch based on .gitignore
;;#+BEGIN_SRC emacs-lisp
