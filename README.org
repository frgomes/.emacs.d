...
;;XXX (use-package yatemplate
;;XXX ;  :defer 2 ;; WORKAROUND https://github.com/mineo/yatemplate/issues/3
;;XXX   :demand
;;XXX   :requires (yasnippet yasnippet-snippets)
;;XXX   :config
;;XXX     (auto-insert-mode)
;;XXX     (setq auto-insert-alist nil)
;;XXX     (yatemplate-fill-alist)
;;XXX     (yas-reload-all)
;;XXX     (yas-global-mode t))
...
#+BEGIN_SRC emacs-lisp
;;FIXME:: Does not work on Windoze
