...
#+BEGIN_SRC emacs-lisp
 (defun list-file-contents (filePath)
   ...
   (if (file-exists-p (expand-file-name filePath))
     ...
     nil))
 (defun load-agenda-files (filePath)
   "Loads agenda files referenced from a configuration file."
   (setq org-agenda-files (list-file-contents filePath)))
 (defun load-trello-files (filePath)
   "Loads agenda files referenced from a configuration file."
   (setq org-trello-files (list-file-contents filePath)))
#+END_SRC
*** Support for multiple agendas
 #+BEGIN_SRC emacs-lisp
 (load-agenda-files "~/Documents/org-mode/agenda")
 #+END_SRC
...
See: https://org-trello.github.io/trello-setup.html
 ...
 #+END_SRC
#+BEGIN_SRC emacs-lisp
 (load-trello-files "~/Documents/org-mode/trello")
#+END_SRC
