...
** TODO [0/1] Configure additional Org Mode modules
*** Support for multiple agendas
 ...
 #+END_SRC
*** TODO [0/1] Support for multiple Trello boards
 ...
 (require 'org-trello)
 (setq orgtrello-log-level orgtrello-log-debug)
 (eval-file "~/Documents/org-mode/config/trello/richardgomes1.el")
 (setq org-trello-files
   (directory-files-recursively "~/Documents/org-mode/trello" ".*\.org$"))
#+END_SRC

 - [ ] C-c o s (sync from Trello to org-trello) is failing with message: 
#+BEGIN_QUOTE
       Symbols's function definition is void: entities-adjacencies
#+END_QUOTE
