...
** Support for programming languages
 ...
 | Dhall                 | dhall-mode  | [[http://github.com/frgomes/bash-scripts/user-install/install-dhall.sh][install-dhall.sh]]     |
 ...
 | Haskell               | lsp-haskell | [[http://github.com/frgomes/bash-scripts/user-install/install-haskell.sh][install-haskell.sh]]   |
 | Lua                   | missing     | missing              |
 ...
 | Rust                  | rust-mode   | [[http://github.com/frgomes/bash-scripts/user-install/install-rust.sh][install-rust.sh]]      |
 | Scala                 | scala-mode  | [[http://github.com/frgomes/bash-scripts/user-install/install-scala.sh][install-scala.sh]]     |
 | Scala SBT             | sbt-mode    | [[http://github.com/frgomes/bash-scripts/user-install/install-scala.sh][install-scala.sh]]     |
